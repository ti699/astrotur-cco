...
interface FiltroSaidasCompactoProps {
  filtros: any;
...
export function FiltroSaidasCompacto({ filtros, setFiltros, opcoesStatus, opcoesClientes, opcoesMonitores, totalResultados, onLimpar }: FiltroSaidasCompactoProps) {
